...
Used <a href="https://github.com/TheAlgorithms/Python" target="_blank">TheAlgorithms/Python</a> for reference while learning. A special thanks to the focks contributing in above mention repo. 

## Search
   - <a href="https://github.com/sagar118/Algorithms-Python/blob/main/Search/linear_search.py" target="_blank">Linear Search</a>
